...
LABEL org.opencontainers.image.authors="horsecma" \
      org.opencontainers.image.description="Application packaged by horsecma" \
      org.opencontainers.image.ref.name="magento-2.4.5" \
      org.opencontainers.image.source="https://dev.azure.com/%20E-Commerce/_git/platform_env-magento" \
